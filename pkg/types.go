...
const (
	...
	ControllerImage                = "quay.io/opct/opct:latest"
	PluginsImage                   = "plugin-openshift-tests:latest"
	CollectorImage                 = "plugin-artifacts-collector:latest"
	MustGatherMonitoringImage      = "must-gather-monitoring:latest"
