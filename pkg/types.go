...
const (
	...
	ControllerImage                = "quay.io/opct/opct:v0.6.2"
	PluginsImage                   = "plugin-openshift-tests:v0.6.2"
	CollectorImage                 = "plugin-artifacts-collector:v0.6.2"
	MustGatherMonitoringImage      = "must-gather-monitoring:v0.6.2"
