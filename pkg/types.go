...
const (
	...
	ControllerImage                = "quay.io/opct/opct:v0.6.4-rc.0"
	PluginsImage                   = "plugin-openshift-tests:v0.6.4-rc.0"
	CollectorImage                 = "plugin-artifacts-collector:v0.6.4-rc.0"
	MustGatherMonitoringImage      = "must-gather-monitoring:v0.6.4-rc.0"
