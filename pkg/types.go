...
const (
	...
	ControllerImage                = "quay.io/opct/opct:v0.6.6"
	PluginsImage                   = "plugin-openshift-tests:v0.6.6"
	CollectorImage                 = "plugin-artifacts-collector:v0.6.6"
	MustGatherMonitoringImage      = "must-gather-monitoring:v0.6.6"
