...
const (
	...
	ControllerImage                = "quay.io/opct/opct:v0.6.7"
	PluginsImage                   = "plugin-openshift-tests:v0.6.7"
	CollectorImage                 = "plugin-artifacts-collector:v0.6.7"
	MustGatherMonitoringImage      = "must-gather-monitoring:v0.6.7"
