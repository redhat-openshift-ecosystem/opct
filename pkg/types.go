...
const (
	...
	ControllerImage                = "quay.io/opct/opct:v0.6.5"
	PluginsImage                   = "plugin-openshift-tests:v0.6.5"
	CollectorImage                 = "plugin-artifacts-collector:v0.6.5"
	MustGatherMonitoringImage      = "must-gather-monitoring:v0.6.5"
